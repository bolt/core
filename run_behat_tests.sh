...
if [[ "$OSTYPE" == "linux-gnu" ]]; then
        ...
        wget https://chromedriver.storage.googleapis.com/78.0.3904.70/chromedriver_linux64.zip -P ./bin
        ...
        wget https://chromedriver.storage.googleapis.com/78.0.3904.70/chromedriver_mac64.zip -P ./bin
