...
describe('Create/delete user', () => {
    it('checks that an admin can create and delete users', () => {
        ...
        cy.get(
            '#multiselect-user_roles > div > div.multiselect__select',
        ).scrollIntoView();
        cy.get(
            '#multiselect-user_roles > div > div.multiselect__select',
        ).click();
        cy.get(
            '#multiselect-user_roles > div > div.multiselect__content-wrapper > ul > li:nth-child(1) > span',
        ).scrollIntoView();
        cy.get(
            '#multiselect-user_roles > div > div.multiselect__content-wrapper > ul > li:nth-child(1) > span',
        ).click();
