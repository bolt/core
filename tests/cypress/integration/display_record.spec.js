...
describe('As a user I want to display a single record', () => {
    ...
    it('checks for correct canonical URL', () => {
        ...
        cy.get("link[rel='canonical']").should('have.attr', 'href', 'http://example.org/page/this-is-a-page');
        ...
        cy.visit('/nl/page/2');
        cy.get("link[rel='canonical']").should('have.attr', 'href', 'http://example.org/nl/page/this-is-a-page');
    });
});
