...
describe('View users and permissions', () => {
    it('checks that an admin can view users and permission', () => {
        ...
        cy.get('table')
            ...
            .find('th')
            .eq(2)
            .should('contain', 'Display name / Email');
        cy.get('table')
            .eq(0)
            .find('thead')
            .find('tr')
    ...
    it('checks that an admin can view the currently running sessions', () => {
        ...
        cy.get('table')
            ...
            .find('th')
            .eq(3)
            .should('contain', 'Session expires');
        cy.get('table')
            .eq(1)
            .find('thead')
            .find('tr')
        ...
        cy.get('table')
            ...
            .find('th')
            .eq(5)
            .should('contain', 'Browser / platform');
