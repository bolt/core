...
describe('As an Admin I want to see the last edited records in the sidebar', () => {
    it('checks that an admin can see the last edited records in the sidebar', () => {
        ...
        cy.get('ul[class="admin__sidebar--menu"]')
            .find('li')
            .eq(3)
            .find('a')
            .find('ul[class="link--menu"]')
            .find('li')
            .its('length')
            .should('eq', 6);
        cy.get('#bolt--sidebar ul li:nth-child(8) ul > li:nth-child(1) > a')
            .find('span')
            .should('contain', 'New');
        cy.get('#bolt--sidebar ul li:nth-child(8) ul > li:nth-child(2) > a')
            .find('span')
            .should('contain', '74: Title of the test');
    });
});
