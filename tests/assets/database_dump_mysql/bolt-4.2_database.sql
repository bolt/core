...
CREATE TABLE `bolt_field_translation` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `bolt_field_translation_unique_translation` (`translatable_id`,`locale`),
...
INSERT INTO `bolt_user` VALUES (1,'admin123','admin','admin123@test.com','$argon2id$v=19$m=65536,t=4,p=1$A3B4EuKl8mCzUZObE88yLQ$W1+CVdOD8QRItsEZkCymh7PwpVpuxa54fmBPCWk7oOU','[\"ROLE_ADMIN\"]',NULL,NULL,'en','default','enabled');
...
CREATE TABLE `bolt_user_auth_token` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `UNIQ_8B90D313A76ED395` (`user_id`),
...
-- Dump completed on 2025-03-07 22:49:46
