...
use Bolt\DependencyInjection\ContentTypesExtension;
...
class Kernel extends BaseKernel
{
    ...
    {
        $container->registerExtension(new BoltExtension());
        $container->registerExtension(new ContentTypesExtension());
    ...
    {
        $ContentTypesParser = new ContentTypesParser('en|nl|es|fr|de|pl|it|hu|pt_BR|ja|nb|nn|nl_NL|nl_BE',
            $this->getProjectDir(), new Collection());
