...
use GraphQL\Language\Parser as BaseParser;
...
class Parser extends BaseParser
{
     ...
     * @param string $kind
     */
    private function peek($kind): bool
    {
     ...
     * @param string $kind
     */
    private function skip($kind): bool
    {
     ...
     * @throws SyntaxError
     */
    private function expect($kind): Token
    {
     ...
     * @throws SyntaxError
     */
    private function expectKeyword($value): Token
    {
        $token = $this->lexer->token;
     ...
     * @throws SyntaxError
     */
    private function any($openKind, $parseFn, $closeKind): NodeList
    {
     ...
     * @throws SyntaxError
     */
    private function many($openKind, $parseFn, $closeKind): NodeList
    {
        $this->expect($openKind);
     ...
     * @param bool $isConst
     */
    private function parseArray($isConst): ListValueNode
    {
        $start = $this->lexer->token;
     ...
     * @param bool $isConst
     */
    private function parseObject($isConst): ObjectValueNode
    {
        $start = $this->lexer->token;
     ...
     * @param bool $isConst
     */
    private function parseObjectField($isConst): ObjectFieldNode
    {
        $start = $this->lexer->token;
        $name = $this->parseName();
     ...
     * @throws SyntaxError
     */
    private function parseDirective($isConst): DirectiveNode
    {
        $start = $this->lexer->token;
     ...
     * @throws SyntaxError
     */
    private function parseInputValueDef(): InputValueDefinitionNode
    {
        $start = $this->lexer->token;
        $description = $this->parseDescription();
        $name = $this->parseName();
