...
> This policy has been copied from the [Open Home Foundation AI Policy](https://github.com/home-assistant/core/blob/57f2e39028cc7f3f8300bf65fac2548d83ab390b/AI_POLICY.md) on 13-08-2026. The only adjustment made was changing the name of the organisation.

We support using AI (i.e., LLMs) as tools when contributing to Bolt projects. However, you are responsible for any contributions you submit, and we are responsible for any contributions we merge and release. We hold a high bar for all contributions to our projects.
...
## Enforcement
Contributions that do not follow this policy will be closed. Repeated violations may result in being blocked from contributing to Bolt projects. If you believe your contribution was closed in error, you are welcome to reach out to a maintainer to discuss.
